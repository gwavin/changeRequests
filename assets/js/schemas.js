(function () {
  ...
  var orderSentenceFields = [
    ...
    field("weightMin", "Weight Min", "text"),
    field("weightMax", "Weight Max", "text"),
  ...
  window.MnCmsSchemas = {
    ...
    requestTypes: [
      ...
      { id: "orderSentence", label: "Order Sentence", description: "Use for dose, route, frequency, duration, PRN, filter, or default-order wording changes.", guidance: ["This mirrors the Order Sentence design columns, including filters and dropdown values.", "For Modify, create one item for Modify From and another for Modify To if that is clearest.", "Dose, route, form, frequency, PRN, duration, and order comments should be completed where relevant."] },
