(function (root) {
  ...
  function create(options) {
    ...
    function renderReview(data) {
      ...
      questionEl.querySelector("[data-email-agenda]").addEventListener("click", function () { options.onEmailAgenda(questionEl.querySelector("[data-email-status]")); });
